...
import {
    ...
    getApp,
    FirebaseApp,
} from "react_app/my-react-app/node_modules/@firebase/app";
import {
    Auth,
    getAuth,
    User,
    ...
    GoogleAuthProvider,
    onAuthStateChanged,
} from "react_app/my-react-app/node_modules/@firebase/auth";
import {
    Database,
    getDatabase,
    child,
    ...
    update,
    push,
} from "react_app/my-react-app/node_modules/@firebase/database";
import { ArucoMarkersInfo, RobotPose } from "../../../../shared/util";
import ROSLIB from "react_app/my-react-app/node_modules/@types/roslib";
